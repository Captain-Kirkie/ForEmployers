...
public class DebuggerPractice {
    ...
    public static void main(String[] args) {
        ...
        // Part 1
        //2 test fail
        //first and last print statement not executed
//
//        if (Part1.binarySearch(arr1, 2) == false) //searhing for two and finding two, should equal, not broken
//            System.out.println("Binary search is broken");
//        if (Part1.binarySearch(arr1, 0) == true)
//            System.out.println("Binary search is broken"); //goal is zero, during second itteration mid becomes zero becuase of int division
