 ...
 * 
 * the number of zeros after 10000 tries how many tries before all the numbers
 * between 1-1000 are generated the number of unique numbers generated in 1000
 * tries the number of odd-even pairs the number of odd-odd pairs the number of
 * even-odd pairs the number of even-even pairs the average number generated
 */
...
//  private final int max_size = 10000;
  ...
  public void check_random(RandomNumberGenerator generator, int seed) {
    ...
    if (this.numbers_filled < this.max_size) {
      ...
      System.out.println("It took " + this.numbers_generated + " generated numbers to hit every possibility from 0 to "
          + this.max_size);
    }
  ...
  public static void main(String[] args) {
    ...
    check_rand.check_random(j_rand, 0);
      ...
      System.out.println("---------------------------------------");
      System.out.println ("Testing Better Random Number Generator"); j_rand = new
      BetterRandomNumberGenerator(); check_rand = new CheckRandomNumberGenerator();
      check_rand.check_random(j_rand, 0);

  }

  /**
   * This function tests to see if setting the seed to the same value returns the
   * same sequence
   * 
   * @param generator
